...
public class multiplicationService {
  ...
  public interface Iface {
    ...
    public complexMap returnComplexMap() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void returnComplexMap(org.apache.thrift.async.AsyncMethodCallback<AsyncClient.returnComplexMap_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public complexMap returnComplexMap() throws org.apache.thrift.TException
    {
      send_returnComplexMap();
      return recv_returnComplexMap();
    }

    public void send_returnComplexMap() throws org.apache.thrift.TException
    {
      returnComplexMap_args args = new returnComplexMap_args();
      sendBase("returnComplexMap", args);
    }

    public complexMap recv_returnComplexMap() throws org.apache.thrift.TException
    {
      returnComplexMap_result result = new returnComplexMap_result();
      receiveBase(result, "returnComplexMap");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "returnComplexMap failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void returnComplexMap(org.apache.thrift.async.AsyncMethodCallback<returnComplexMap_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      returnComplexMap_call method_call = new returnComplexMap_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class returnComplexMap_call extends org.apache.thrift.async.TAsyncMethodCall {
      public returnComplexMap_call(org.apache.thrift.async.AsyncMethodCallback<returnComplexMap_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("returnComplexMap", org.apache.thrift.protocol.TMessageType.CALL, 0));
        returnComplexMap_args args = new returnComplexMap_args();
        args.write(prot);
        prot.writeMessageEnd();
      }

      public complexMap getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_returnComplexMap();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("returnComplexMap", new returnComplexMap());
      return processMap;
    }
    ...
    private static class returnComplexMap<I extends Iface> extends org.apache.thrift.ProcessFunction<I, returnComplexMap_args> {
      public returnComplexMap() {
        super("returnComplexMap");
      }

      public returnComplexMap_args getEmptyArgsInstance() {
        return new returnComplexMap_args();
      }

      public returnComplexMap_result getResult(I iface, returnComplexMap_args args) throws org.apache.thrift.TException {
        returnComplexMap_result result = new returnComplexMap_result();
        result.success = iface.returnComplexMap();
        return result;
      }
  ...
  public static class returnComplexMap_args implements org.apache.thrift.TBase<returnComplexMap_args, returnComplexMap_args._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("returnComplexMap_args");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new returnComplexMap_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new returnComplexMap_argsTupleSchemeFactory());
    }
...
;
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(returnComplexMap_args.class, metaDataMap);
    }

    public returnComplexMap_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public returnComplexMap_args(returnComplexMap_args other) {
    }

    public returnComplexMap_args deepCopy() {
      return new returnComplexMap_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof returnComplexMap_args)
        return this.equals((returnComplexMap_args)that);
      return false;
    }

    public boolean equals(returnComplexMap_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(returnComplexMap_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      returnComplexMap_args typedOther = (returnComplexMap_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("returnComplexMap_args(");
      boolean first = true;
    ...
    private static class returnComplexMap_argsStandardSchemeFactory implements SchemeFactory {
      public returnComplexMap_argsStandardScheme getScheme() {
        return new returnComplexMap_argsStandardScheme();
      }
    }

    private static class returnComplexMap_argsStandardScheme extends StandardScheme<returnComplexMap_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, returnComplexMap_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, returnComplexMap_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class returnComplexMap_argsTupleSchemeFactory implements SchemeFactory {
      public returnComplexMap_argsTupleScheme getScheme() {
        return new returnComplexMap_argsTupleScheme();
      }
    }

    private static class returnComplexMap_argsTupleScheme extends TupleScheme<returnComplexMap_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, returnComplexMap_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, returnComplexMap_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
  ...
  public static class returnComplexMap_result implements org.apache.thrift.TBase<returnComplexMap_result, returnComplexMap_result._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("returnComplexMap_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new returnComplexMap_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new returnComplexMap_resultTupleSchemeFactory());
    }

    public complexMap success; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, complexMap.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(returnComplexMap_result.class, metaDataMap);
    }

    public returnComplexMap_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public returnComplexMap_result(returnComplexMap_result other) {
      if (other.isSetSuccess()) {
        this.success = new complexMap(other.success);
      }
    }

    public returnComplexMap_result deepCopy() {
      return new returnComplexMap_result(this);
    }
    ...
    public complexMap getSuccess() {
      return this.success;
    }

    public returnComplexMap_result setSuccess(complexMap success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof returnComplexMap_result)
        return this.equals((returnComplexMap_result)that);
      return false;
    }

    public boolean equals(returnComplexMap_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(returnComplexMap_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      returnComplexMap_result typedOther = (returnComplexMap_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("returnComplexMap_result(");
      boolean first = true;
    ...
    private static class returnComplexMap_resultStandardSchemeFactory implements SchemeFactory {
      public returnComplexMap_resultStandardScheme getScheme() {
        return new returnComplexMap_resultStandardScheme();
      }
    }

    private static class returnComplexMap_resultStandardScheme extends StandardScheme<returnComplexMap_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, returnComplexMap_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, returnComplexMap_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class returnComplexMap_resultTupleSchemeFactory implements SchemeFactory {
      public returnComplexMap_resultTupleScheme getScheme() {
        return new returnComplexMap_resultTupleScheme();
      }
    }

    private static class returnComplexMap_resultTupleScheme extends TupleScheme<returnComplexMap_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, returnComplexMap_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, returnComplexMap_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new complexMap();
